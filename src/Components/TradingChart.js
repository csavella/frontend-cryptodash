...
import { useContext } from "react";
import { chartContext } from "./chartContext";
>>>>>>> 51fee7488a6425487d103d514d77bcb725375ae3
...
export default function LineChart() {
  ...
  const FiveCoinsDataURL =
    "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=bitcoin%2Cethereum%2Cbinancecoin%2Ctether%2Ccardano&order=market_cap_desc&per_page=100&page=1&sparkline=true&price_change_percentage=%271h%2C24h%27";
...
=======
  useEffect(() => {
    ...
    coindata.forEach((element) => {
      ...
      sparklines24h[element.name] = sparklines7d[element.name].slice(
        length - 24
      );
    });
  ...
  function getFormattedDate(hour, day, newdate) {
    ...
    if (newdate.length === 0) hour = split_time[0];
...
>>>>>>> 51fee7488a6425487d103d514d77bcb725375ae3
      ...
      let length;
      if (Object.values(data7d)[0]) length = Object.values(data7d)[0].length;
